...
const SUCCESS_SUBSCRIBE = 'Подписка автивирована';
const SUCCESS_UNSUBSCRIBE = 'Вы отписались, я не обиделся';

const MSG_ABOUT = 'Этот бот мониторит каналы с объявлениями, сортирует их по категориям и выдает вам то, на что вы подпишитесь. По сути, снимает с вас необходимость мониторить 8-10 каналов';
